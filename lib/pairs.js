const pairs = [
    {token0name:"DOT",token1name:"LCDOT",token0id:"DOT",token1id:"lc://13",rev:false,types:["subquery","onchain"],source:"acala",acalapool:[{TOKEN: "DOT"},{liquidcrowdloan:"13"}]},
    {token0name:"AUSD",token1name:"LDOT",token0id:"AUSD",token1id:"LDOT",rev:false,types:["subquery","onchain"],source:"acala",acalapool:[{TOKEN: "AUSD"},{TOKEN:"LDOT"}]},
    {token0name:"cDOT613",token1name:"DOT",token0id:"200060013",token1id:"101",rev:false,types:["onchain"],source:"parallel"},
]
